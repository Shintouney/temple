class Invoices::CheckJob < ActiveJob::Base
  queue_as :default

  # Check Invoices and Payments inconsistencies
  def perform
    ...
    ::ApplicationController.helpers.display_results(double_paid_invoices)
    ...
    ::ApplicationController.helpers.display_results(unmatched_paid_invoices)
    ...
    ::ApplicationController.helpers.display_results(unmatched_retry_invoices)

    payments = Payment.all
    puts "\n\rChecking #{ payments.size } payments to belong to one and only invoice..."
    unmatched_payments = check_payments_invoice(payments)
    ::ApplicationController.helpers.display_results(unmatched_payments)
    ...
    ::ApplicationController.helpers.display_results(invoice_ids)
