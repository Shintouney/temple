...
SimpleForm.setup do |config|
  ...
  config.wrappers :checkbox, tag: :div, class: "checkbox", error_class: "has-error" do |b|
    ...
    b.wrapper tag: :label do |ba|
      ba.use :input
      ba.use :label_text, wrap_with: { tag: 'strong', class: 'control-label' }
    end
  ...
  config.wrappers :bootstrap3_horizontal, tag: 'div', class: 'form-group', error_class: 'has-error', defaults: { input_html: { class: 'form-group default_class' } } do |b|
